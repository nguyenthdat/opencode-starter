...
**Use the edit tool, not sed or ad hoc Python scripts.** The edit tool forces specificity about what to replace and where, yielding better reliability. Run bundled Python helpers through `uv run python`.
