...
- `uvx --from "markitdown[pptx]" markitdown` - text extraction without global installs
- `uv run --with Pillow python scripts/thumbnail.py ...` - thumbnail grids when Pillow is not already available
