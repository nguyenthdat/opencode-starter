...
The cross-domain links are where a knowledge _graph_ starts beating a folder of documents — surface one concrete example using the user's own notes during Phase 5.
