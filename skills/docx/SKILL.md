...
**Use the edit tool directly for string replacement. Do not write ad hoc Python scripts.** Scripts introduce unnecessary complexity. If a bundled Python helper is needed, run it through `uv run python`.
